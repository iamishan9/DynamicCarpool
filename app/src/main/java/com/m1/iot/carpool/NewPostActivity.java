...
import com.m1.iot.carpool.fragment.DatePickerFragment;
import com.m1.iot.carpool.fragment.TimePickerFragment;
import com.m1.iot.carpool.models.DriverOfferPost;
import com.m1.iot.carpool.models.RideRequestPost;
        ...
        formCarousel.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if(position == 0) {
                    ...
                    mSourceField.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME, Place.Field.ADDRESS, Place.Field.LAT_LNG));
                    ...
                    mSourceField.setOnPlaceSelectedListener(new PlaceSelectionListener() {
                        ...
                        public void onError(Status status) {
                            ...
                            Log.i(TAG, "317 An error occurred: " + status);
                        }
                    });
                    if(state_changed){
                        state_changed = false;
                ...
                if(position == 1) {
                    ...
                    mDestinationField.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME, Place.Field.ADDRESS, Place.Field.LAT_LNG));
                    ...
                    mDestinationField.setOnPlaceSelectedListener(new PlaceSelectionListener() {
                        ...
                        public void onPlaceSelected(Place place) {
                            //TODO: Get info about the selected place
                            Log.i(TAG, "Place: " + place.getName());
                            destination_place = place.getAddress();
                        ...
                        public void onError(Status status) {
                            //TODO: Handle the error
                            Log.i(TAG, "355 An error occurred: " + status);
                        }
                    });
                    if(state_changed){
                        state_changed = false;
        ...
        public View setViewForPosition(int i) {
            ...
            if(i == 0) {
                ...
                if (!Places.isInitialized()) {
                    Places.initialize(getApplicationContext(), "AIzaSyAmNVox81iAKbWOCEvTBrZ_oezJj8juL-A");
                }

                // Initialize the AutocompleteSupportFragment.
                AutocompleteSupportFragment autocompleteFragment = (AutocompleteSupportFragment)
                        getSupportFragmentManager().findFragmentById(R.id.field_source);
...
//                        System.out.println(place.getLatLng());
                        ...
                        source_place = place.getAddress();
                        location_latlng = place.getLatLng();
//                        source_place = place.getLatLng();
                    }

                    @Override
                    public void onError(Status status) {
                        // TODO: Handle the error.
                        Log.i(TAG, " 458 An error occurred: " + status);
                    }
                });
...
//                    public void onError(Status status) {
//                        //TODO: Handle the error
//                        Log.i(TAG, "440 An error occurred: " + status);
//                    }
//                });
//
//
...
//                    public void onError(Status status) {
//                        //TODO: Handle the error
//                        Log.i(TAG, "467 An error occurred: " + status);
//                    }
//                });
//            }
            if(i == 1) {
                ...
                // Initialize the AutocompleteSupportFragment.
                AutocompleteSupportFragment autocompleteFragment = (AutocompleteSupportFragment)
                        getSupportFragmentManager().findFragmentById(R.id.field_destination);
                ...
                autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
                    ...
                    public void onPlaceSelected(Place place) {
                        ...
                        Log.i(TAG, "Place: " + place.getName());
                        destination_place = place.getAddress();
                        location_latlng2 = place.getLatLng();
                        if(destination_place != null && !destination_place.equals("")) {
                            NewPostActivity.this.location_latlng = NewPostActivity.this.getLocationFromAddress(NewPostActivity.this, NewPostActivity.this.source_place);
                            NewPostActivity.this.location_latlng2 = NewPostActivity.this.getLocationFromAddress(NewPostActivity.this, NewPostActivity.this.destination_place);
                            SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map2);
                    ...
                    public void onError(Status status) {
                        // TODO: Handle the error.
                        Log.i(TAG, " 550 An error occurred: " + status);
                    }
                });
...
//        DriverOfferPost driverPost = new DriverOfferPost(userId, username, source, destination, count, dep_time, arr_time, t_day);
    ...
    private void writeNewRideRequestPost(String userId, String username, String source, String destination, LatLng pickupPoint,
        ...
        RideRequestPost rideRequest = new RideRequestPost(userId, username, source, destination, pickupPoint, dep_time, arr_time, t_day);
...
//        childUpdates.put("/posts/rideRequests/" + key, postValuesPickupPoint);


        childUpdates.put("/user-posts/" + userId + "/rideRequests/" + key, postValues);
//        childUpdates.put("/user-posts/" + userId + "/rideRequests/" + key, postValuesPickupPoint);
