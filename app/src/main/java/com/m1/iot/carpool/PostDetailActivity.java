...
//import androidx.recyclerview.widget.FloatingActionButton;
...
import com.m1.iot.carpool.fragment.RouteWayPointListFragment;
...
import com.m1.iot.carpool.models.Comment;
import com.m1.iot.carpool.models.WayPoint;
...
public class PostDetailActivity extends MainActivity
    ...
    private void loadWayPointList() {
        ...
        Fragment wayPointListFragment = new Fragment();
